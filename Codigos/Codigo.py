...
# Este programa permite agregar, listar y buscar estudiantes
# Usa listas, tuplas, diccionarios, cadenas, bucles while y condicionales.

# Lista vacía donde guardaremos a los estudiantes
estudiantes = []

# Bucle principal que mantiene activo el menú hasta que el usuario decida salir
while True:
    print("\n--- MENÚ PRINCIPAL ---")
